...
import base.view.charts.ChartFactory.swing.RotateLabelUI;
import java.awt.*;
...
import base.view.charts.ChartFactory.uisupport.HTMLTextArea;
import base.view.charts.ChartFactory.uisupport.TransparentToolBar;
import base.view.charts.ChartFactory.uisupport.UISupport;
import base.view.charts.ChartFactory.uisupport.VerticalLayout;
...
public class SimpleXYChartUtils {
    ...
    public static String formatBytes(long value) {
        return MessageFormat.format("{0} B", formatDecimal(value));
    }
    ...
    private static String createDetailsString(String[] detailsItems, String[] values) {
        ...
        while (i < detailsItems.length) {
            ...
            sb.append(MessageFormat.format("<b>{0}: </b>{1}", detailsItems[i],
